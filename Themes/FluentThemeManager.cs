...
{
    private static readonly Uri BaseUri = new("avares://RobotAIArm/Styles");
    ...
    private static readonly Styles FluentDark = new()
    {
        new StyleInclude(BaseUri)
        {
            Source = new Uri("avares://RobotAIArm/Themes/FluentDark.axaml")
        }
    };
    ...
    private static readonly Styles FluentLight = new()
    {
        new StyleInclude(BaseUri)
        {
            Source = new Uri("avares://RobotAIArm/Themes/FluentLight.axaml")
        }
    };
